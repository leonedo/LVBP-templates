...
var equipos = {
    "tigres" : ["compuertatigres", "logopeqtigres"],
    "aguilas":["compuertaaguilas", "logopeqaguilas"],
    "magallanes":["compuertamagallanes", "logopeqmagallanes"],
    "leones":["compuertaleones", "logopeqleones"],
    "tiburones":["compuertatiburones", "logopeqtiburones"],
    "cardenales":["compuertacardenales", "logopeqcardenales"],
    "caribes":["compuertacaribes", "logopeqcaribes"],
    "bravos":["compuertabravos", "logopeqbravos"]
}
...
let anim = loadAnimation('derecho.json', animContainer)
let externalLoop;
